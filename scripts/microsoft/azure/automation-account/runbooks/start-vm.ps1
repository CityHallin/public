...
<#
    ...
    .DESCRIPTION
        ...
        - Runbook must be set for PowerShell version 5+ or 7+
        - The Azure Automation Account must have a System-Managed ID attached
        - The System-Managed ID must have permission to impact needed Azure resources

    .LINK
    Github: https://github.com/CityHallin/public
    License: https://raw.githubusercontent.com/CityHallin/public/main/LICENSE
